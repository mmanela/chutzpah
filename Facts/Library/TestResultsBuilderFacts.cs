    ...
    public class TestCaseStreamReaderFacts
    {
        ...
        public class Read
        {
            ...
            public void Will_throw_argument_null_exception_if_stream_is_null()
            {
                ...
                var model = Record.Exception(() => reader.ClassUnderTest.Read(null, new TestContext(), TestRunnerMode.Execution, null, true)) as ArgumentNullException;
            ...
            public void Will_throw_argument_null_exception_if_context_is_null()
            {
                ...
                var model = Record.Exception(() => reader.ClassUnderTest.Read(stream, null, TestRunnerMode.Execution, null, true)) as ArgumentNullException;
            ...
            public void Will_fire_file_started_event()
            {
                ...
                reader.ClassUnderTest.Read(stream, context, TestRunnerMode.Execution, callback.Object, false);
...
";
                ...
                var summary = reader.ClassUnderTest.Read(stream, context, TestRunnerMode.Execution, callback.Object, false);
            ...
            public void Will_put_logs_in_summary()
            {
                ...
                var json = @"
#_#Logs#_# {""type"":""Logs"",""Logs"":[{""message"":""hi""},{""message"":""bye""}]}
";
                var context = new TestContext { InputTestFile = "file" };
                var stream = new StreamReader(new MemoryStream(Encoding.UTF8.GetBytes(json)));
                var callback = new Mock<ITestMethodRunnerCallback>();
            ...
            [Fact]
            public void Will_put_errors_in_summary()
            {
                var reader = new TestableTestCaseStreamReader();

                var json = @"
#_#Errors#_# {""type"":""Errors"",""Errors"":[{""message"":""uhoh"", stack:""trace""}]}
";
                var context = new TestContext { InputTestFile = "file" };
                var stream = new StreamReader(new MemoryStream(Encoding.UTF8.GetBytes(json)));
                var callback = new Mock<ITestMethodRunnerCallback>();
                ...
                Assert.Equal("trace", summary.Errors[0].Stack);
            }
        }
    }
    /*
